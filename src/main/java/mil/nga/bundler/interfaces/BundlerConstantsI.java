...
public interface BundlerConstantsI {
    ...
    /**
     * In the standalone version of the bundler the server name is not 
     * relevant as it refers to the the JVM name running the bundle job. 
     * In order to maintain backwards compatibility the server name will be 
     * set to this constant.
     */
    public static final String DEFAULT_SERVER_NAME = "standalone";
